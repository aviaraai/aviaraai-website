...
<section className="bg-gray-900 text-white pt-32 pb-16 px-6 md:px-10">
          ...
          <p className="mt-4 text-gray-200 max-w-2xl">
            End-to-end AI systems, production pipelines, and intelligent
            automation tailored to your product and business workflows.
          </p>
        </div>
      </section>
      ...
      <main className="max-w-5xl mx-auto px-6 md:px-10 py-10 md:py-14">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          <li>Custom model development (vision, NLP, recommendation, etc.).</li>
          <li>MLOps pipelines for training, deployment, and monitoring.</li>
          <li>Integration with existing data infrastructure and APIs.</li>
          <li>Experiment tracking, model versioning, and A/B testing.</li>
        </ul>
